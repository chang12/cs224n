...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(initial_value=np.zeros([Config.n_features, Config.n_classes]), dtype=tf.float32)
        b = tf.Variable(initial_value=np.zeros(Config.n_classes), dtype=tf.float32)
